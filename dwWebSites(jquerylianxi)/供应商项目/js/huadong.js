...
//by zyp
;(function($,window,document,undefined){var Silder=function(ele,opt){this.$element=ele,this.defaults={width:0,height:0,direction:'x',few:1,showFew:1,clearance:0,silderMode:'linear',timeGap:600,auto:true,autoType:'left',autoTime:5,buttonPre:'.zuo',buttonNext:'.you',jz:true,runEnd:function(){}},this.options=$.extend({},this.defaults,opt);}
